...
<br><br>![alt](https://github.com/m-ayush-2004/Beyond-Binary/blob/main/assets/w1.png)
...
<br><br>![alt](https://github.com/m-ayush-2004/Beyond-Binary/blob/main/assets/w2.png)
...
<br><br>![alt](https://github.com/m-ayush-2004/Beyond-Binary/blob/main/assets/w3.png)
...
<br><br>![alt](https://github.com/m-ayush-2004/Beyond-Binary/blob/main/assets/w4.png)
...
<br><br>![alt](https://github.com/m-ayush-2004/Beyond-Binary/blob/main/assets/w5.png)
...
2. **Copy the Script Tag**: A script tag will be generated containing your Firebase configuration details. This includes important information such as your API key, Auth domain, Database URL, Project ID, Storage bucket, Messaging sender ID, App ID, and Measurement ID. 
   ...
   ```html
     ...
     const firebaseConfig = {
       ...
       authDomain: "Beyond-Binary.firebaseapp.com",
       databaseURL: "https://Beyond-Binary-default-rtdb.firebaseio.com",
       projectId: "Beyond-Binary",
       storageBucket: "Beyond-Binary.appspot.com",
...
<br><br>![alt](https://github.com/m-ayush-2004/Beyond-Binary/blob/main/assets/w6.png)
...
2. **Create the Structure**: Create the structure as shown in the image. You need to set up the following paths:
   - `https://Beyond-Binary-default-rtdb.firebaseio.com/distance/id/x`
   - `https://Beyond-Binary-default-rtdb.firebaseio.com/distance/id/y`

<br><br>![alt](https://github.com/m-ayush-2004/Beyond-Binary/blob/main/assets/w7.png)
...
---
<br><br>![alt](https://github.com/m-ayush-2004/Beyond-Binary/blob/main/assets/w8.png)
